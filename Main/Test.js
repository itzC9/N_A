...
// @grant        GM_openInTab
// @require      htttps://auto-bypass.onrender.com/api/codex
// @grant        none
...
(function () {
    ...
    // --- Delta/Platorelay Bypass ---
    function handleLootLink() {
    ...
    // --- Dispatcher ---
    if (url.includes('lootdest.com/s?') || url.includes('auth.platorelay.com')) {
        handleLootLink();
    } else if (url.includes('spdmteam.com/key-system')) {
        setTimeout(handleArceusX, 100); // instantly but allow DOM check
 }
})();
